...
int main(void) 
{
  ...
  unsigned int y ;;
	...
	LCD_write_english_string(20,150,"Guanfu_wang   2010-04-05",RED,BLACK);
	LCD_write_english_string(20,170,"Atmega32 & OTM3225A FOR OV7670 REV3.1",GREEN,BLACK);
	...
	//LCD_write_english_string(20,210,"OV7670 Init......",BLUE,BLACK);
